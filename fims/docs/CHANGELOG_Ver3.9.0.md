...
- Set the Province panel to a fixed width of 275 px.
- The width is sized so the longest Province label, `17 Autonomus Bougainville Govemment`, remains on one line under the current UI typography.
