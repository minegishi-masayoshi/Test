/* =========================================================
   ...
   Final Survey Information layout
========================================================= */
...
function extractSurveyInformation() {
  return [
    [
      "Survey Name",
      normalizePdfText(
...
function extractAllReportData() {
  return {
    title:
      "ASSESSMENT SUMMARY - ALL BLOCKS",

    subtitle:
      "FIPS Survey Assessment Report",

    version:
      "FIPS Cloud version 1.0",

    surveyInformation:
      extractSurveyInformation(),
...
function drawSurveyInformationTable(
  doc,
  rows,
  startY
) {
...
async function generateFipsPdf() {
  ...
  doc.setProperties({
    ...
    subject:
      "FIPS Assessment Summary - All Blocks",
  ...
  y =
    drawSurveyInformationTable(
      doc,
      reportData.surveyInformation,
      y
    );
