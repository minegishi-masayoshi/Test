...
cp "${APP_DIR}/main.py" "${APP_DIR}/main.py.bak_ver36_${STAMP}"
cp "${APP_DIR}/import_auto_api.py" "${APP_DIR}/import_auto_api.py.bak_ver36_${STAMP}" 2>/dev/null || true

cp "${SOURCE_DIR}/import_auto_api.py" "${APP_DIR}/import_auto_api.py"
cp "${SOURCE_DIR}/constraint_api.py" "${APP_DIR}/constraint_api.py"
chown ubuntu:ubuntu "${APP_DIR}/import_auto_api.py" "${APP_DIR}/constraint_api.py"
...
cd "${APP_DIR}"
./venv/bin/python -m py_compile main.py import_auto_api.py constraint_api.py
