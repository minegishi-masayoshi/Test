...
function activateSummaryLayer(key) {
  ...
  const definitions = {
    district: ["Administrative", "District boundaries"],
...
function initializeUi() {
  ...
  $("#summaryStatus").textContent =
    connected ? "GeoServer configured" : "Prototype data";
...
function start() {
  ...
  try {
    ...
    const districtCheckbox =
      document.querySelector(
        'input[data-layer="district"]'
      );
    ...
    setStatus(
      "FIMS Cloud failed to start. Check the browser console."
    );
